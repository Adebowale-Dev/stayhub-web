          ...
          {status === 'input' && (<Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Input id="paymentCode" type="text" placeholder="Enter 6-character code (e.g., ABC123)" value={paymentCode} onChange={(e) => {
                const value = e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, '');
                if (value.length <= 6) {
                    setPaymentCode(value);
                }
            }} className="text-center text-2xl font-mono tracking-widest h-14" maxLength={6} autoFocus/>
          ...
          {status === 'success' && (<Card>
              <CardContent className="pt-12 pb-12">
                <div className="text-center space-y-6">
                  ...
                  {paymentDetails && (<div className="bg-green-50 rounded-lg p-6 space-y-3 text-left max-w-md mx-auto border border-green-200">
                      ...
                      {paymentDetails.amount && (<div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Amount Paid</span>
                          <span className="font-bold text-green-700">₦{paymentDetails.amount.toLocaleString()}</span>
                        </div>)}
                      
                      {paymentDetails.reference && (<div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Reference</span>
                          <span className="font-mono text-sm">{paymentDetails.reference}</span>
                        </div>)}

                      {paymentDetails.paymentCode && (<div className="flex justify-between">
                      ...
                      {paymentDetails.paidAt && (<div className="flex justify-between">
          ...
          {status === 'failed' && (<Card>
              <CardContent className="pt-12 pb-12">
                <div className="text-center space-y-6">
                  ...
                  {paymentDetails && (<div className="bg-muted rounded-lg p-6 space-y-3 text-left max-w-md mx-auto">
                      {paymentDetails.amount && (<div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Amount Paid</span>
