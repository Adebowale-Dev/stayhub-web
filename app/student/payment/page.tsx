...
export default function StudentPaymentPage() {
    ...
    const getStatusBadge = (status: string) => {
        ...
        return (<Badge variant="outline" className={statusConfig.className}>
    ...
    return (<ProtectedRoute allowedRoles={['student']}>
      <DashboardLayout>
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          {(paymentInfo?.status === 'paid' || paymentInfo?.status === 'completed' || paymentInfo?.status === 'success') && (<Alert className="bg-green-50 border-green-200">
          ...
          {paymentInfo?.status === 'pending' && (<Alert className="bg-orange-50 border-orange-200">
          ...
          {!reservation && (<Alert className="bg-blue-50 border-blue-200">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {paymentInfo?.reference && (<div className="flex items-center justify-between py-2">
                    <span className="text-sm text-muted-foreground">Reference</span>
                    <span className="text-sm font-mono">{paymentInfo.reference}</span>
                  </div>)}

                {paymentInfo?.paidAt && (<div className="flex items-center justify-between py-2">
                ...
                {paymentInfo?.expiresAt && paymentInfo.status !== 'paid' && (<div className="flex items-center justify-between py-2">
                    <span className="text-sm text-muted-foreground flex items-center gap-1">
