...
export default function PendingCheckInsPage() {
  ...
  const loadPendingStudents = async () => {
    ...
    try {
      ...
      // Filter for pending check-ins (students with room assignments but not checked in)
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder="Search by name, matric number, email, phone, or room..."
                    value={searchQuery}
                            ...
                            <TableRow key={student._id}>
                              ...
                              <TableCell>
                                <div className="flex flex-col gap-1 text-sm">
                                  ...
                                  {student.level && (
                                    <span className="text-gray-500">Level {student.level}</span>
                                  )}
                                </div>
                              </TableCell>
                              <TableCell>
                              ...
                              <TableCell className="text-right">
                                <Button
                                  size="sm"
                                  onClick={() => router.push(`/porter/checkin?student=${student._id}`)}
                                >
                                  <UserCheck className="h-4 w-4 mr-2" />
                                  Check In
                                </Button>
